...
public class MiddleService extends AskServiceGrpc.AskServiceImplBase {
    ...
    // Stub bloqueante: El hilo se detendrá esperando la respuesta del servidor final
    ...
    public MiddleService() {
        ...
        // Este servicio necesita conectarse al 'FinalServer' que corre en el puerto 50053.
        // -------------------------------------------------------------------
        ...
        // 2. IMPORTANTE: Desactiva SSL/TLS porque estamos en desarrollo (.usePlaintext()).
        ManagedChannel channel = ManagedChannelBuilder
                .________("localhost", 50053)
                ._____________() // <--- ¡Sin esto fallará la conexión local!
                .build();

        // TODO 2: Crea el Stub (El objeto cliente)
        // Usa el método estático .newBlockingStub(channel) de la clase generada ResponseServiceGrpc
